...
# Lee el Access Token de las variables de entorno de Render
...
# -----------------------------------------------
# RUTA PARA RECIBIR AVISOS DE PAGO (WEBHOOK) - VERSIÓN CORREGIDA
# -----------------------------------------------
@app.route('/mercadopago-webhook', methods=['POST'])
def mercadopago_webhook():
    print("\n--- INICIANDO WEBHOOK ---")
    try:
        # Se ha eliminado el bloque de verificación de firma que causaba el error.
        ...
        if data and data.get("type") == "payment":
            ...
            print("4. BUSCANDO INFORMACIÓN DEL PAGO...")
            ...
            if payment.get("status") == "approved":
                ...
                try:
                    response_pi = requests.post(RASPBERRY_PI_URL, json={'pedido_id': pedido_id, 'expiracion': time.time() + expiracion, 'qr_texto': qr_content}, timeout=10)
            ...
            print("2. Notificación ignorada (no es de tipo 'payment' o no tiene datos).")
